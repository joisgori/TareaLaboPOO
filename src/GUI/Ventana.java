...
public class Ventana extends JPanel {
    ...
    public Ventana() {
        ...
        textF2.setBounds(new Rectangle(20, 200, widthTF, heightTF));

        textF3 = new JTextField();
        textF3.setBounds(new Rectangle(20, 60, widthTF, heightTF));

        //Agregué otro campo, donde este funcionará solo para la conversión;        
        textF4 = new JTextField();
        textF4.setBounds(new Rectangle(200, 20, widthTF, heightTF));

        buttonS = new JButton("+");
        buttonS.setBounds(new Rectangle(20, 115, widthB, heightB));

        buttonR = new JButton("-");
        buttonR.setBounds(new Rectangle(75, 115, widthB, heightB));

        buttonM = new JButton("*");
        buttonM.setBounds(new Rectangle(20, 150, widthB, heightB));

        buttonD = new JButton("/");
        buttonD.setBounds(new Rectangle(75, 150, widthB, heightB));

        //Agrego el botón que funcionará para realizar la conversión a binario.
        buttonCb = new JButton("Binario");
        buttonCb.setBounds(new Rectangle(200, 125, 100, heightB));
